        ...
        <aside className="bg-white p-4 rounded-lg shadow-md w-full lg:w-1/4">
          ...
          <div className="mt-4 p-4 border-t border-gray-300">
            ...
            <p className="text-sm text-gray-700 mb-2">
              Мы всегда ищем талантливых и мотивированных людей для
              присоединения к нашей команде. Если вы хотите развиваться в
              дружной и профессиональной среде, отправьте нам свое резюме.
            </p>
            <a href="#apply" className="text-yellow-500 hover:text-yellow-600">
              Узнать больше
            </a>
          </div>
        </aside>
        ...
        <main className="bg-white p-8 rounded-lg shadow-md w-full lg:w-3/4">
          ...
          <div className="flex justify-between items-center mt-8">
            <button className="text-yellow-500 hover:text-yellow-600">
              <IosShareIcon className="relative bottom-1" />
              Поделиться
            </button>
            <button className="text-yellow-500 hover:text-yellow-600">
              <PrintIcon className="relative bottom-1" />
              Распечатать
            </button>
          </div>
          <Discount />
