...
import Balls from "@/public/images/watersport.webp";
...
const Products = () => {
  ...
  return (
    <div className="container mx-auto p-8">
      ...
      <div className="flex">
        <div className="w-1/4 p-4 bg-white rounded-lg shadow-lg relative bottom-4">
          ...
          {visibleProducts < initialProducts.length && (
            <div className="mt-8 flex justify-center">
              <button
                ...
                className="relative w-screen bottom-4 cursor-pointer px-4 py-2 bg-yellow-500 text-white font-semibold rounded-lg hover:bg-yellow-600 transition-colors duration-300"
              >
                Показать ещё
              </button>
            </div>
